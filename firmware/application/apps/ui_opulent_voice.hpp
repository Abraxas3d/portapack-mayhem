...
namespace ui
{
    class OPVView : public View                                // App class declaration
    {
    public:
        OPVView(NavigationView &nav);                          // App class init function declaration
        std::string title() const override { return "Opulent Voice"; }; // App title
